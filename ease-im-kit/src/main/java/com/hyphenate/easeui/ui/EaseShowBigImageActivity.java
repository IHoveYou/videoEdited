...
//						pd.setMessage(str2 + progress + "%");
		...
		saveImgToLocal(this, ((EMImageMessageBody) msg.getBody()).getRemoteUrl());

//		String remoteUrl =  ((EMImageMessageBody) msg.getBody()).getRemoteUrl();
//		LogUtil.e( "download with getRemoteUrl: " +remoteUrl);
//		PreviewPictureActivity.startActivity(EaseShowBigImageActivity.this, new ArrayList<String>(Arrays.asList(new String[]{remoteUrl})) ,0);
//		finish();
//		return;
	}
	/**
		...
		Glide.with(context)
				...
				.listener(new RequestListener<File>() {
					...
					public boolean onResourceReady(File resource, Object model, Target<File> target, DataSource dataSource, boolean isFirstResource) {
						Glide.with(EaseShowBigImageActivity.this).asBitmap().load(resource).into(image);
						return false;
					}
				})
				.preload();
