...
//                    }
    ...
    private void setMenuByMsgType(EMMessage message) {
        ...
        MenuItemBean itemBean = menuHelper.findItem(R.id.action_chat_delete);
        if (itemBean != null)
            itemBean.setTitle(getContext().getString(R.string.action_delete));
        switch (type) {
            case TXT:
            ...
            case IMAGE:
                ...
                break;
            case VOICE:
                if ( menuHelper.findItem(R.id.action_chat_delete)!=null)
